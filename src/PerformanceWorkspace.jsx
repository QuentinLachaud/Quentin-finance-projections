  ...
  return <div className="performance-workspace">
    <section className="panel performance-summary">
      ...
      {properties.length ? <>
        ...
        <details className="performance-method"><summary><CircleHelp size={14} /> What these numbers include <ChevronDown size={15} /></summary><div><p><b>Annualised return</b> is XIRR across dated investment cash flows, with current net property equity treated as today’s terminal value. <b>Net income</b> uses dated Documents & Expenses entries plus eligible Banking transactions; matching entries are deduplicated, and DLA/internal transfers stay outside property operating profit.</p><p>Historical rent, costs and valuations are shown only where a dated record exists. The app does not backfill current assumptions into the past. Forecasts start at Today and use the shared portfolio assumptions.</p></div></details>
